...
export type BankWhereInput = {
  ...
  createdBy?: Prisma.IntNullableFilter<"Bank"> | number | null
  updatedAt?: Prisma.DateTimeNullableFilter<"Bank"> | Date | string | null
  updatedBy?: Prisma.IntNullableFilter<"Bank"> | number | null
  deletedAt?: Prisma.DateTimeNullableFilter<"Bank"> | Date | string | null
  deletedBy?: Prisma.IntNullableFilter<"Bank"> | number | null
}
...
export type BankScalarWhereWithAggregatesInput = {
  ...
  createdBy?: Prisma.IntNullableWithAggregatesFilter<"Bank"> | number | null
  updatedAt?: Prisma.DateTimeNullableWithAggregatesFilter<"Bank"> | Date | string | null
  updatedBy?: Prisma.IntNullableWithAggregatesFilter<"Bank"> | number | null
  deletedAt?: Prisma.DateTimeNullableWithAggregatesFilter<"Bank"> | Date | string | null
  deletedBy?: Prisma.IntNullableWithAggregatesFilter<"Bank"> | number | null
}
...
export type BankOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"code" | "name" | "createdAt" | "createdBy" | "updatedAt" | "updatedBy" | "deletedAt" | "deletedBy", ExtArgs["result"]["bank"]>
...
export interface BankDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const bankWithCodeOnly = await prisma.bank.findMany({ select: { code: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many Banks and only return the `code`
   * const bankWithCodeOnly = await prisma.bank.createManyAndReturn({
   *   select: { code: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more Banks and only return the `code`
   * const bankWithCodeOnly = await prisma.bank.updateManyAndReturn({
   *   select: { code: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface BankFieldRefs {
  ...
  readonly createdBy: Prisma.FieldRef<"Bank", 'Int'>
  readonly updatedAt: Prisma.FieldRef<"Bank", 'DateTime'>
  readonly updatedBy: Prisma.FieldRef<"Bank", 'Int'>
  readonly deletedAt: Prisma.FieldRef<"Bank", 'DateTime'>
  readonly deletedBy: Prisma.FieldRef<"Bank", 'Int'>
}
