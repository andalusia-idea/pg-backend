...
export type BalanceSnapshotWhereInput = {
  ...
  updatedAt?: Prisma.DateTimeFilter<"BalanceSnapshot"> | Date | string
  updatedBy?: Prisma.IntFilter<"BalanceSnapshot"> | number
}
...
export type BalanceSnapshotWhereUniqueInput = Prisma.AtLeast<{
  holderType_holderId_bucket?: Prisma.BalanceSnapshotHolderTypeHolderIdBucketCompoundUniqueInput
  AND?: Prisma.BalanceSnapshotWhereInput | Prisma.BalanceSnapshotWhereInput[]
  OR?: Prisma.BalanceSnapshotWhereInput[]
  NOT?: Prisma.BalanceSnapshotWhereInput | Prisma.BalanceSnapshotWhereInput[]
  holderId?: Prisma.IntFilter<"BalanceSnapshot"> | number
...
export type BalanceSnapshotScalarWhereWithAggregatesInput = {
  ...
  updatedAt?: Prisma.DateTimeWithAggregatesFilter<"BalanceSnapshot"> | Date | string
  updatedBy?: Prisma.IntWithAggregatesFilter<"BalanceSnapshot"> | number
}
...
export type BalanceSnapshotHolderTypeHolderIdBucketCompoundUniqueInput = {
  holderType: $Enums.BalanceHolderTypeEnum
  holderId: number
  bucket: $Enums.BalanceBucketEnum
}
...
export interface BalanceSnapshotDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * 
   * // Only select the `holderId`
   * const balanceSnapshotWithHolderIdOnly = await prisma.balanceSnapshot.findMany({ select: { holderId: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many BalanceSnapshots and only return the `holderId`
   * const balanceSnapshotWithHolderIdOnly = await prisma.balanceSnapshot.createManyAndReturn({
   ...
   * })
   * 
   * // Update zero or more BalanceSnapshots and only return the `holderId`
   * const balanceSnapshotWithHolderIdOnly = await prisma.balanceSnapshot.updateManyAndReturn({
   *   select: { holderId: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface BalanceSnapshotFieldRefs {
  ...
  readonly updatedAt: Prisma.FieldRef<"BalanceSnapshot", 'DateTime'>
  readonly updatedBy: Prisma.FieldRef<"BalanceSnapshot", 'Int'>
}
